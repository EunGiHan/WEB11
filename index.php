...
<body>
  <div class="container">
    ...
    <div class="reviewbox" style="overflow:hidden;">
      <?php
      $sql = "SELECT *, reviews.star as r_star FROM reviews LEFT JOIN stores
              ON reviews.store_id = stores.id ORDER BY created DESC limit 3";
      ...
      while($row = mysqli_fetch_array($result)){
        ...
        echo "<div style='float:left'>
                <a href=\"./src/store_page.php?store_id={$row['store_id']}\">"."{$row['name']}".
                "</a></div><br>";
